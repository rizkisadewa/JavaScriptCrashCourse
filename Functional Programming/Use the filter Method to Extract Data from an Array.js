...
for(let i=0;i<filteredList.length;i++){
  console.log("title "+(i+1)+" : "+filteredList[i].title+" and Rating : "+filteredList[i].rating);
}

/*
Another useful array function is Array.prototype.filter(), or simply filter(). The filter method returns a new array which is at most as long as the original array,
but usually has fewer items.
