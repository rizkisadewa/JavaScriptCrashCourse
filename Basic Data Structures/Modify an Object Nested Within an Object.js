...
1. userActivity has id, date and data properties
2. userActivity has a data key set to an object with keys totalUsers and online
3. The online property nested in the data key of userActivity should be set to 45
4. The online property is set using dot or bracket notation
*/
