...
/*
You may have noticed that some freeCodeCamp JavaScript challenges include their own console.
This console behaves a little differently than the browser console you used in the last challenge.
...
1. Use console.log() to print the outputTwo variable. In your Browser Console this should print out the value of the variable two times.
2. Use console.log() to print the outputOne variable.
3. Use console.clear() to modify your output so that outputOne variable only outputs once.
*/
