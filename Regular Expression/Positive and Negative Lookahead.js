...
3. Your regex should not match "airplanes"
4. Your regex should not match "banan1"
5. Your regex should match "bana12"
6. Your regex should match "abc123"
7. Your regex should not match "123"
8. Your regex should not match "1234"
*/
