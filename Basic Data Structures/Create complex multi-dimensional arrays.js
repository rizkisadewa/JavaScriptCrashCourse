...
console.log(myNestedArray[1][1][0][0])
...
much of which you will see in later sections.
...
and booleans for data elements, so that it has exactly five levels of depth (remember, the outer-most array is level 1). Somewhere on the third level,
